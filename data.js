/* =====================================================================
 *  data.js: THE BATTLE OF JABURO (賈布羅戰役). A self-playing 3D documentary.
 *  ---------------------------------------------------------------------
 *  A FICTIONAL battle from "Mobile Suit Gundam" (機動戰士鋼彈, Sunrise, 1979),
...
window.BATTLE_DATA = (function () {
  ...
  const factions = {
    ...
    zeon: { main:0xcf2a2a, glow:0xff6a55, dim:0x7a1717, css:"#cf2a2a", name_zh:"吉翁公國軍", name_en:"Principality of Zeon",     role:"attacker", maxStrength:2800, defaultFlag:"zeon" },
  };
  ...
  const meta = {
    ...
    title:"賈布羅戰役", subtitle:"機動戰士鋼彈 · 一年戰爭 · The Battle of Jaburo · U.C.0079",
  ...
  const intro = { title_zh:"賈布羅戰役", title_en:"The Battle of Jaburo",
    sub_zh:"機動戰士鋼彈 · 一年戰爭 · U.C.0079.11.30", sub_en:"Mobile Suit Gundam · One Year War · U.C. 0079",
  ...
  const outro = { title_zh:"賈布羅，巋然不動", title_en:"Jaburo Stands",
    narration_zh:"地球聯邦守住了賈布羅。這是一場虛構的戰役，謹依《機動戰士鋼彈》設定，重現於真實的圭亞那高地之上。",
  ...
  const flagLegend = [
    ...
    { flag:"zeon", zh:"吉翁公國軍", en:"Principality of Zeon",     faction:"zeon" },
  ];
  ...
  const geography = {
    ...
    points: [
      ...
      { name_zh:"賈布羅太空港閘門", name_en:"Jaburo Spaceport Gate", type:"fort", lng:-60.772, lat:5.112 },
  ...
  const units = [
    ...
    { id:"eff_hq", faction:"eff", kind:"command", flag:"eff", cf:false,
      name_zh:"賈布羅司令部", name_en:"Jaburo HQ", type:"Headquarters",
      track:[ {d:29, lng:-60.765, lat:5.132, s:1200, st:"hold"},
              {d:30.9, lng:-60.765, lat:5.132, s:1200, st:"hold"} ] },
    { id:"eff_whitebase", faction:"eff", kind:"ship", flag:"eff", cf:true,
    ...
    { id:"eff_gundam", faction:"eff", kind:"mecha", flag:"eff", cf:true,
      name_zh:"鋼彈", name_en:"RX-78-2 Gundam", type:"Mobile Suit",
    ...
    { id:"eff_support", faction:"eff", kind:"mecha", flag:"eff", cf:true,
      name_zh:"鋼加農隊", name_en:"Guncannon & Guntank battery", type:"Support Mobile Suit",
    ...
    { id:"eff_beam", faction:"eff", kind:"defense", flag:"eff", cf:true,
    ...
    { id:"zeon_madangler", faction:"zeon", kind:"sub", flag:"zeon", cf:true,
    ...
    { id:"zeon_char", faction:"zeon", kind:"mecha", flag:"zeon", cf:true,
      name_zh:"夏亞・茲寇克", name_en:"Char's MSM-07S Z'Gok", type:"Commander Mobile Suit",
    ...
    { id:"zeon_gaw", faction:"zeon", kind:"air", flag:"zeon", cf:true,
      name_zh:"卡烏母艦隊", name_en:"Gaw carriers & Dopp fighters", type:"Air carrier group",
    ...
    { id:"zeon_acguy", faction:"zeon", kind:"mecha", flag:"zeon", cf:true,
      name_zh:"亞凱突擊隊", name_en:"Acguy commandos", type:"Commando Mobile Suit",
  ...
  const storyboard = [
    ...
    { day:29.7, hold:8, cam:{lng:-60.83, lat:5.07, dist:650, az:-68, el:32, orbit:0.6},
      ...
      narration_zh:"夏亞的馬德安格拉潛艦隊溯河而上，水陸兩用機體在暗流中逼近太空港的閘門。",
      ...
      side:"zeon", focus:["zeon_madangler","zeon_char"], commanders:[{zh:"夏亞・阿茲納布爾",en:"Char Aznable"}] },
    ...
    { day:30.0, hold:9, cam:{lng:-60.80, lat:5.07, dist:950, az:28, el:46, orbit:0.6},
      ...
      narration_zh:"拂曉，卡烏空中母艦掠過大薩瓦納草原，薩克、古夫與德姆自天而降。賈布羅之戰就此爆發。",
    ...
    { day:30.05, hold:7, cam:{lng:-60.80, lat:5.07, dist:380, az:-6, el:34, orbit:1.0},
      ...
      narration_zh:"薩克與德姆重重砸落草原，揚起漫天塵土。吉翁的鋼鐵巨人已踏上賈布羅的門前。",
    ...
    { day:30.35, hold:9, cam:{lng:-60.787, lat:5.10, dist:480, az:60, el:36, orbit:0.9},
      ...
      narration_zh:"夏亞的紅色茲寇克破開水下入口，率水陸兩用隊突入要塞。聯邦的吉姆量產型傾巢而出迎戰。",
      ...
      side:"both", focus:["zeon_char","eff_gm"], commanders:[{zh:"夏亞・阿茲納布爾",en:"Char Aznable"}] },
    ...
    { day:30.45, hold:13, cam:{lng:-60.785, lat:5.10, dist:340, az:200, el:30, orbit:2.2},
      title_zh:"紅彗星與鋼彈", title_en:"The Red Comet and the Gundam", dateLabel:"U.C. 0079.11.30 · 午後 Afternoon",
      narration_zh:"夏亞與阿姆羅的鋼彈正面交鋒。伍迪駕駛凡凡氣墊機決死衝撞，擊損夏亞的主攝影機，迫使紅彗星後撤，自己卻命喪當場。",
      ...
      side:"both", focus:["zeon_char","eff_gundam"], commanders:[{zh:"阿姆羅・雷",en:"Amuro Ray"},{zh:"伍迪・馬爾汀",en:"Woody Malden"}] },
    // 9. TIGHT on the sabotage (~3.4 km), swing back.
    { day:30.55, hold:9, cam:{lng:-60.775, lat:5.11, dist:460, az:-40, el:38, orbit:0.8},
      title_zh:"亞凱的破壞工作", title_en:"The Acguy Sappers", dateLabel:"U.C. 0079.11.30 · 午後 Afternoon",
      narration_zh:"亞凱突擊隊潛入，於吉姆生產工廠安放定時炸彈。白色基地的孩子們發現了破壞者，及時示警，炸彈被拆除。",
    ...
    { day:30.75, hold:9, cam:{lng:-60.82, lat:5.07, dist:900, az:-90, el:42, orbit:0.9},
      ...
      narration_zh:"抵抗過於頑強，吉翁未能達成任何目標。夏亞掩護殘部撤離，賈布羅的閘門依舊緊閉。",
      ...
      side:"zeon", focus:["zeon_char","zeon_amphib"], commanders:[{zh:"夏亞・阿茲納布爾",en:"Char Aznable"}] },
  ...
  const notes = {
    summary:"「賈布羅戰役」是動畫《機動戰士鋼彈》（Sunrise, 1979）中的虛構戰役，發生於宇宙世紀（U.C.）0079 年 11 月 30 日的一年戰爭期間。吉翁公國軍由夏亞・阿茲納布爾率領，奇襲地球聯邦軍位於南美的地下總司令部賈布羅，最終為聯邦所擊退。本片為依據作品設定、重現於真實地形之上的紀錄片式重構，並非真實歷史。 The Battle of Jaburo is a fictional engagement from Mobile Suit Gundam (Sunrise, 1979), set on 30 November U.C. 0079 during the One Year War: Zeon, led by Char Aznable, makes a surprise assault on the Earth Federation's underground headquarters and is repulsed. This is a documentary-style reconstruction over real terrain, not real history.",
    caveats:[
      "虛構戰役：所有部隊、事件與人物均出自《機動戰士鋼彈》（Sunrise, 1979），並非真實歷史。 This is a fictional battle: every force, event and character is from Mobile Suit Gundam (Sunrise, 1979), not real history.",
      "地理為真實地形的代用。賈布羅在原始動畫設定於亞馬遜盆地，後期設定（《THE ORIGIN》）改置於圭亞那高地。本片採用真實的羅賴馬山／庫克南山一帶作為代用地點；任何官方作品皆未載明其經緯度。 Geography is a real-world stand-in. Jaburo sits in the Amazon basin in the original anime and is relocated to the Guiana Highlands in later canon (The Origin). This production uses the real Mount Roraima / Kukenan area as a stand-in; no official work gives coordinates.",
      ...
      "兵力與戰損數字（如吉翁投入逾五十架MS、損失過半）出自設定資料集（Entertainment Bible #39 等），非電視畫面直接呈現；片中數值僅作示意。 Force and loss figures (e.g. 50+ Zeon MS committed, over half lost) come from supplementary guidebooks (Entertainment Bible #39), not shown directly on screen; values here are illustrative.",
      "吉翁軍溯行的具體河流於原作未具名；片中沿庫克南河的行軍路線為本片之編排。 The specific river the Zeon force ascended is unnamed in canon; the Kukenan-River route shown here is this production's staging.",
      "旗幟為一年戰爭時期的勢力徽記：吉翁為紅底金色徽紋，聯邦為金色徽記（藍底為後製重建色）。皆為虛構徽記，非任何真實世界的違禁符號。 Flags are the One-Year-War faction emblems: Zeon's gold crest on red, the Federation's gold emblem (the blue field is a reconstructed colour). Both are fictional insignia, not any real-world prohibited symbol.",
