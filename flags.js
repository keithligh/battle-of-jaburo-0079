/* =====================================================================
 *  flags.js: the bundled Example Battle's flags (pure canvas art, no image assets).
 *  ---------------------------------------------------------------------
 ...
 *
 *  These two flags ("blue" / "red") are DELIBERATELY FICTIONAL: abstract faction
 *  emblems on a solid field. This is an invented demo battle, so they must NOT
 *  resemble any real nation's flag (no real tricolour, roundel, star or crest).
 *
 *  To build your own battle, do NOT edit this file: copy the skeleton
 *  flags.example.js and draw YOUR forces' real, PERIOD-CORRECT flags (e.g. a 1941
 *  ensign, not the modern flag), and NEVER a prohibited symbol. The PRIMITIVES
 *  below compose most real national flags (tricolours, crosses, roundels, stars).
 * ===================================================================== */
...
/* ---- the battle's flags (ids referenced from data.js). For a REAL battle, replace these with your
 *  forces' real period-correct flags. Composition ideas for real flags, in the same style:
...
const flags = {
  // FICTIONAL faction emblems, abstract on a solid field, deliberately NOT any real national flag.
  blue: (c) => { fill(c, "#1f4f9e"); tri(c,   W * 0.5, H * 0.54, H * 0.32, "#f1f1ea"); },  // Blue Force: a white triangle
  red:  (c) => { fill(c, "#b01e2a"); rhomb(c, W * 0.5, H * 0.50, H * 0.36, "#f1f1ea"); },   // Red Force: a white diamond
};
